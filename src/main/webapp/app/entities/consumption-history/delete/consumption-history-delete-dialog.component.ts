...
@Component({
  standalone: true,
  templateUrl: './consumption-history-delete-dialog.component.html',
  imports: [SharedModule, FormsModule],
})
export class ConsumptionHistoryDeleteDialogComponent {
  ...
  confirmDelete(id: number): void {
    this.consumptionHistoryService.delete(id).subscribe(() => {
