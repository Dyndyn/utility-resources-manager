...
describe('Household Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'household', component: HouseholdComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.households?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to householdService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getHouseholdIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getHouseholdIdentifier).toHaveBeenCalledWith(entity);
