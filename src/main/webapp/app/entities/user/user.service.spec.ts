...
describe('User Service', () => {
  ...
  describe('Service methods', () => {
    it('should return Users', () => {
      ...
      req.flush([new User(123, 'user', 'test', 'test')]);
      expect(expectedResult).toEqual([{ id: 123, login: 'user', firstName: 'test', lastName: 'test' }]);
    });
    ...
    describe('addUserToCollectionIfMissing', () => {
      ...
      it('should add only unique User to an array', () => {
        const userArray: IUser[] = [{ id: 123 }, { id: 456 }, { id: 17182 }];
        const userCollection: IUser[] = [{ id: 456 }];
